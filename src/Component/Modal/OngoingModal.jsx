...
function ChildModal(props) {
    ...
    const handleComplete = () => {
        ...
        DoerService.markTaskForApproval(token,taskId)
            .then((response) => {
                console.log("about to mark task as completed");
                console.log(taskId);
            ...
            <div className="modal-button">
                <>
                    {userRole === "TASKER" ? (
                        ...
                        <button className="dashboard-button" onClick={handleComplete}>
                    ...
                    <div className="task-completed-task-completed">
                        <div className="task-completed-main-accept">
                            ...
                            <div className="task-completed-task-accept">
                                <>
                                    {userRole === "TASKER" ? (
                                        <p className="task-completed-task-accepted">Task Approved</p>
                                    ) : (
                                        <p className="task-completed-task-accepted">Task is Pending Approval</p>
                                    )}
                                </>
                                    ...
                                    <div className="task-completed-task-page">
                                        <>
                                            {userRole === "TASKER" ? (
                                                ...
                                                <p className="task-completed-you-have-accepted-th">
                                                    A notification has been sent to the tasker to approve the task.
                                                </p>
                                            )}
                                        </>
                                    </div>
