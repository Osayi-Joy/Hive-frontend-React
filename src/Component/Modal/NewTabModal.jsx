...
function ChildModal(props) {
    ...
    const handleCancel = () => {
        ...
        console.log(token);
        TaskerService.cancelTask(token, props?.id)
            .then((response) => {
                    ...
                    <div className="task-completed-task-completed">
                        <div className="task-completed-main-accept">
                            ...
                            <div className="task-completed-task-accept">
                                <>
                                    {userRole === "TASKER" ? (
                                        <p className="task-completed-task-accepted">Task Successfully Cancelled</p>
                                    ) : (
                                        <p className="task-completed-task-accepted">Task Successfully Accepted</p>
                                    )}
                                </>
                                    ...
                                    <div className="task-completed-task-page">
                                        <>
                                            {userRole === "TASKER" ? (
                                                ...
                                                <p className="task-completed-you-have-accepted-th">
                                                    Kindly ensure you complete the task within the stipulated time
                                                </p>
                                            )}
                                        </>
